      ...
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          ...
          if (data.status === 'success') {
            (0, _alert.showAlert)('success', 'user login successfully');
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 3:
          _context2.p = 3;
          _t2 = _context2.v;
          (0, _alert.showAlert)('error', 'something went wrong while logging out! Try Again.');
        case 4:
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          (0, _alert.showAlert)('error', 'There is something wrong');
        case 3:
          return _context.a(2);
      }
    }, _callee, null, [[0, 2]]);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "4193" + '/');
